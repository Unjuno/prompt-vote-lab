...
11. [Support policy](./support-policy.md) — support boundaries.
12. [Report policy](./report-policy.md) — weekly report draft policy.
13. [Pre-API freeze checklist](./pre-api-freeze.md) — gates before paid agent runs.
