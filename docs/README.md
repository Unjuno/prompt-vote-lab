...
12. [Support policy](./support-policy.md) — support boundaries.
13. [Report policy](./report-policy.md) — weekly report draft policy.
14. [Pre-API freeze checklist](./pre-api-freeze.md) — gates before paid agent runs.
